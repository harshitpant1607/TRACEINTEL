export const INITIAL_WALLETS = [
  {
    ...
    associatedEntity: 'ShadowRoute Mixer',
    clusterId: 'CL-9021',
    layeringHops: 5,
    rapidMovement: true,
    isNew: false,
    structuringFlag: true
  },
  {
    ...
    associatedEntity: 'Synthetic Intermediary Cluster',
    clusterId: 'CL-9021',
    layeringHops: 3,
    rapidMovement: true,
    isNew: true,
  ...
  },
  {
    ...
    associatedEntity: 'Atlas OTC Desk',
    clusterId: 'CL-9021',
    layeringHops: 2,
    rapidMovement: false,
    isNew: false,
  ...
  },
  {
    ...
    riskScore: 88,
    riskLevel: 'CRITICAL',
    label: 'ShadowRoute Mixer Portal',
  ...
  },
  {
    ...
    riskScore: 73,
    riskLevel: 'HIGH',
    label: 'Nova Exchange Proxy (Source)',
  ...
  },
  {
    ...
    riskScore: 12,
    riskLevel: 'LOW',
    label: 'CipherBridge Settlement Hub',
    tags: ['Verified VASP', 'Regulated Settlement'],
    ...
    associatedEntity: 'CipherBridge Exchange',
    clusterId: 'CL-0001',
    layeringHops: 0,
    rapidMovement: false,
    isNew: false,
...
export const INITIAL_TRANSACTIONS = [
  ...
  },
  {
    ...
    timeSincePreviousHop: '7m 14s',
    riskReasons: [
      'Direct transfer to ShadowRoute Mixer Portal',
  ...
  },
  {
    ...
    timeSincePreviousHop: '15m 00s',
    riskReasons: [
      'Standard exchange proxy withdrawal'
    ]
  }
];
...
export const INITIAL_INVESTIGATIONS = [
  {
    ...
    summary: 'Automated intelligence rules flagged wallet 0x71C8...A92F executing rapid high-volume USDT transfers through 5 intermediary hop addresses within 36 minutes, terminating at a known ShadowRoute Mixer portal.',
    riskIndicators: [
    ...
    timeline: [
      { time: '09:42', title: 'Initial Deposit Detected', desc: '300,000 USDT withdrawn from Nova Exchange Proxy 0x9E21...E21A.', txHash: '0xe164d527a425261708943526170894352617089435261708943526170894d17f' },
      { time: '09:47', title: 'Funds Transferred to Intermediary', desc: '250,000 USDT routed through buffer wallet 0x82FA...B10C.', txHash: '0xd053c416f314150697832415069783241506978324150697832415069783c06e' },
      { time: '09:52', title: 'Funds Split Across Accounts', desc: 'Transfers split into $184.2K and $30K tranches.', txHash: '0xc942b305e203049586721304958672130495867213049586721304958672b95d' },
      { time: '10:03', title: 'Layering Hub Consolidation', desc: '184,200 USDT received at Mixing Hub 0x71C8...A92F.', txHash: '0xa72f9d84c1b920194857102938475610293847561029384756102938475691f3' },
      { time: '10:11', title: 'High-Risk Destination Transfer', desc: '$92,000 USDT deposited into ShadowRoute Mixer portal.', txHash: '0xb831a294d102938475610293847561029384756102938475610293847561a84c' },
      { time: '10:18', title: 'Critical Threat Escalated', desc: 'TRACEINTEL Risk Engine trigger rule #804 fired; case auto-generated.' }
    ],
    analystNotes: [
      { date: '2026-08-18 10:22', author: 'Inv. Sarah Vance', text: 'Initiated asset-preservation query with VASP compliance liaison for Nova Exchange proxy address.' },
      { date: '2026-08-18 10:45', author: 'Inv. Mark Sterling', text: 'Graph analysis confirms 0x71C8 is part of Cluster CL-9021 linked to an unverified off-market syndicate.' }
    ],
    recommendedActions: [
      'Issue recommended asset-preservation review to Nova Exchange VASP compliance portal.',
      'Submit cluster tag update to cross-entity intelligence reference database.',
      'Generate full Regulatory Review Report for analyst documentation.'
    ]
  },
  {
    id: 'INV-2026-001',
...
export const INITIAL_CASES = [
  {
    id: 'CP-2026-004',
    name: 'INV-2026-004 — USDT Layering Review',
    priority: 'Critical',
    targetWallet: '0x71C8F91A2B5E43C988D3E105634A9F01289EA92F',
    riskScore: 94,
    ...
    description: 'Investigation into automated high-frequency laundering of USDT proceeds originating from unauthorized exchange proxy withdrawals.'
  },
  {
    id: 'CP-2026-001',
    ...
    description: 'Long-term monitoring of ShadowRoute Mixer Portal liquidity pools.'
  },
  {
    id: 'CP-2026-002',
...
export const INITIAL_ALERTS = [
  {
    ...
    status: 'Unresolved',
    investigationId: 'INV-2026-004',
    message: '$184,200 USDT transferred through 5 intermediary wallets in < 36 mins. Destination linked to ShadowRoute Mixer portal.'
  },
  {
    id: 'ALT-8898',
  ...
  },
  {
    ...
    status: 'Under Review',
    investigationId: 'INV-2026-001',
    message: 'Direct fund transfer into ShadowRoute Mixer contract address.'
  },
  {
    id: 'ALT-8870',
...
export const INITIAL_ENTITIES = [
  {
    ...
    jurisdiction: 'Tor Network / Synthetic',
    description: 'Privacy-focused mixing protocol identified in synthetic cybercrime proceeds anonymization.'
  },
  {
    id: 'ENT-02',
    name: 'Nova Exchange',
    ...
    status: 'Under Review',
    jurisdiction: 'Synthetic Regional VASP',
  ...
  },
  {
    ...
    status: 'Monitored',
    jurisdiction: 'Off-market / Synthetic',
    description: 'Institutional liquidity provider offering non-custodial fiat off-ramping services.'
  },
  {
    id: 'ENT-04',
    name: 'Vector Settlement Hub',
    type: 'Settlement Infrastructure',
    riskScore: 35,
    riskLevel: 'MEDIUM',
    connectedWallets: 88,
    volumeMonitored: '$64.1M',
    status: 'Under Review',
    jurisdiction: 'Synthetic VASP Hub',
    description: 'Cross-chain liquidity bridge supporting structured asset transfers.'
  },
  {
    id: 'ENT-05',
    name: 'CipherBridge Exchange',
    ...
    jurisdiction: 'Synthetic Compliant VASP',
    description: 'Regulated digital asset platform featuring automated compliance API integrations.'
  }
];
...
export const GRAPH_DATA = {
  nodes: [
    ...
    { id: 'n5', address: '0x3F881920A4B100293C817029F710A029B8103F88', label: 'ShadowRoute Mixer (Dest)', type: 'Sanctioned Mixer', riskScore: 88, level: 'CRITICAL', x: 900, y: 250, inflow: '$5.4M', outflow: '$5.39M', txs: 4210 },
    { id: 'n6', address: '0xBBBBCCCCDDDDEEEEFFFF00001111222233334444', label: 'CipherBridge (Regulated)', type: 'Regulated VASP', riskScore: 12, level: 'LOW', x: 700, y: 380, inflow: '$120M', outflow: '$118M', txs: 890000 }
  ],
  edges: [
    { from: 'n1', to: 'n2', amount: '$300,000 USDT', asset: 'USDT', time: '15m 00s', txHash: '0xe164d527a425261708943526170894352617089435261708943526170894d17f', riskScore: 42 },
    { from: 'n2', to: 'n3', amount: '$184,200 USDT', asset: 'USDT', time: '11m 09s', txHash: '0xc942b305e203049586721304958672130495867213049586721304958672b95d', riskScore: 78 },
    { from: 'n3', to: 'n4', amount: '$184,200 USDT', asset: 'USDT', time: '4m 12s', txHash: '0xa72f9d84c1b920194857102938475610293847561029384756102938475691f3', riskScore: 94 },
    { from: 'n4', to: 'n5', amount: '$92,000 USDT', asset: 'USDT', time: '7m 14s', txHash: '0xb831a294d102938475610293847561029384756102938475610293847561a84c', riskScore: 88 }
  ]
};
